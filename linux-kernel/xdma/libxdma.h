...
/*inspur define register */
struct regs_base {
         //1.
         u32 major_version_l;     // RO,0x00
	 u32 major_version_h;     // RO,0x04
         u32 minor_version_l;     // RO,0x08
         u32 minor_version_h;     // RO,0x0c
         //2.
         u32 tupledesc_addr_l;    // R/w,0x10
         u32 tupledesc_addr_h;    // R/W,0x14
     	 u32 tupledesc_len_l;     // R/W,0x18
         u32 tupledesc_len_h;     // R/W,0x1c
         //3.
	 u32 qual_addr_l;         // R/w,0x20
         u32 qual_addr_h;         // R/W,0x24
         u32 qual_len_l;          // R/W,0x28
         u32 qual_len_h;          // R/W,0x2c
         //4.
         u32 targetlist_addr_l;   // R/w,0x30
         u32 targetlist_addr_h;   // R/W,0x34
         u32 targetlist_len_l;    // R/W,0x38
         u32 targetlist_len_h;    // R/W,0x3c
        
         //7.
         u32 reset_all_l;          // R/W,0x40
         u32 reset_all_h;          // R/W,0x44
 };

//5. 
struct regs_src_addr {
         //5.1
         u32 src_addr0_l;         // R/w,0x100
         u32 src_addr0_h;         // R/W,0x104
         u32 src_len0_l;          // R/w,0x108
         u32 src_len0_h;          // R/W,0x10c
         //5.2
         u32 src_addr1_l;         // R/w,0x110
         u32 src_addr1_h;         // R/W,0x114
         u32 src_len1_l;          // R/w,0x118
         u32 src_len1_h;          // R/W,0x11c
         //5.3
         u32 src_addr2_l;         // R/w,0x120
         u32 src_addr2_h;         // R/W,0x124
         u32 src_len2_l;          // R/w,0x128
         u32 src_len2_h;          // R/W,0x12c
         //5.4
         u32 src_addr3_l;         // R/w,0x130
         u32 src_addr3_h;         // R/W,0x134
         u32 src_len3_l;          // R/w,0x138
         u32 src_len3_h;          // R/W,0x13c
};
//6.
struct regs_dst_addr {
         //6.1
         u32 dst_addr0_l;         // R/w,0x200
         u32 dst_addr0_h;         // R/W,0x204
         u32 dst_len0_l;          // R/w,0x208
         u32 dst_len0_h;          // R/W,0x20c
         //6.2
         u32 dst_addr1_l;         // R/w,0x210
         u32 dst_addr1_h;         // R/W,0x214
         u32 dst_len1_l;          // R/w,0x218
         u32 dst_len1_h;          // R/W,0x21c
         //6.3
         u32 dst_addr2_l;         // R/w,0x220
         u32 dst_addr2_h;         // R/W,0x224
         u32 dst_len2_l;          // R/w,0x228
         u32 dst_len2_h;          // R/W,0x22c
         //6.4
         u32 dst_addr3_l;         // R/w,0x230
         u32 dst_addr3_h;         // R/W,0x234
         u32 dst_len3_l;          // R/w,0x238
         u32 dst_len3_h;          // R/W,0x23c
};

//8.
struct regs_calc_start_reset {
         //8.1
         u32 calc_start0_l;       // R/w,0x300
         u32 calc_start0_h;       // R/w,0x304
         u32 calc_reset0_l;       // R/w,0x308
         u32 calc_reset0_h;       // R/w,0x30c
         //8.2
         u32 calc_start1_l;       // R/w,0x310
         u32 calc_start1_h;       // R/w,0x314
         u32 calc_reset1_l;       // R/w,0x318
         u32 calc_reset1_h;       // R/w,0x31c
         //8.3
         u32 calc_start2_l;       // R/w,0x320
         u32 calc_start2_h;       // R/w,0x324
         u32 calc_reset2_l;       // R/w,0x328
         u32 calc_reset2_h;       // R/w,0x32c
         //8.4
         u32 calc_start3_l;       // R/w,0x330
         u32 calc_start3_h;       // R/w,0x334
         u32 calc_reset3_l;       // R/w,0x338
         u32 calc_reset3_h;       // R/w,0x33c
  
};

//9.
struct regs_tq_dma_done {
         u32 tupledesc_dma_done_l;// R/w,0x400
         u32 tupledesc_dma_done_h;// R/w,0x404
         u32 test_l;              // R/w,0x408     
         u32 test_h;              // R/w,0x40c
         u32 qual_dma_done_l;     // R/w,0x410
         u32 qual_dma_done_h;     // R/w,0x414
};


//10.
struct regs_cacl_state {
         //10.1
         u32 cacl_state0_l;       // R/w,0x500
         u32 cacl_state0_h;       // R/w,0x504
         //10.2
         u32 cacl_state1_l;       // R/w,0x510
         u32 cacl_state1_h;       // R/w,0x414
         //10.3
         u32 cacl_state2_l;       // R/w,0x520
         u32 cacl_state2_h;       // R/w,0x524
         //10.4
         u32 cacl_state3_l;       // R/w,0x530
         u32 cacl_state3_h;       // R/w,0x534

};

//11.
struct regs_cacl_done {
         //11.1
         u32 cacl_done0_l;       // R/w,0x600
         u32 cacl_done0_h;       // R/w,0x604
         //11.2
         u32 cacl_done1_l;       // R/w,0x610
         u32 cacl_done1_h;       // R/w,0x614
         //11.3
         u32 cacl_done2_l;       // R/w,0x620
         u32 cacl_done2_h;       // R/w,0x624
         //11.4
         u32 cacl_done3_l;       // R/w,0x630
         u32 cacl_done3_h;       // R/w,0x634
};

//12.
struct regs_cacl_err {
         //12.1
         u32 cacl_err0_l;       // R/w,0x700
         u32 cacl_err0_h;       // R/w,0x704
         //12.2
         u32 cacl_err1_l;       // R/w,0x710
         u32 cacl_err1_h;       // R/w,0x714
         //12.3
         u32 cacl_err2_l;       // R/w,0x720
         u32 cacl_err2_h;       // R/w,0x724
         //12.4
         u32 cacl_err3_l;       // R/w,0x730
         u32 cacl_err3_h;       // R/w,0x734
};

//13.
struct regs_cacl_done_irq {
         //13.1
         u32 calc_done_irq0_l;       // R/w,0x800
         u32 calc_done_irq0_h;       // R/w,0x804
         //13.2
         u32 calc_done_irq1_l;       // R/w,0x810
         u32 calc_done_irq1_h;       // R/w,0x814
         //13.3
         u32 calc_done_irq2_l;       // R/w,0x820
         u32 calc_done_irq2_h;       // R/w,0x824
         //13.4
         u32 calc_done_irq3_l;       // R/w,0x830
         u32 calc_done_irq3_h;       // R/w,0x834
};

//14.
struct regs_cacl_time {
         //14.1
         u32 src_input_start_time0_l;       // R/w,0x900
         u32 src_input_start_time0_h;       // R/w,0x904
         u32 src_input_done_time0_l;        // R/w,0x908
         u32 src_input_done_time0_h;        // R/w,0x90c
         u32 src_calc_done_time0_l;         // R/w,0x910
         u32 src_calc_done_time0_h;         // R/w,0x914
         //14.2
         u32 src_input_start_time1_l;       // R/w,0x920
         u32 src_input_start_time1_h;       // R/w,0x924
         u32 src_input_done_time1_l;        // R/w,0x928
         u32 src_input_done_time1_h;        // R/w,0x92c
         u32 src_calc_done_time1_l;         // R/w,0x930
         u32 src_calc_done_time1_h;         // R/w,0x934
         //14.3
         u32 src_input_start_time2_l;       // R/w,0x940
         u32 src_input_start_time2_h;       // R/w,0x944
         u32 src_input_done_time2_l;        // R/w,0x948
         u32 src_input_done_time2_h;        // R/w,0x94c
         u32 src_calc_done_time2_l;         // R/w,0x950
         u32 src_calc_done_time2_h;         // R/w,0x954
         //14.4
         u32 src_input_start_time3_l;       // R/w,0x960
         u32 src_input_start_time3_h;       // R/w,0x964
         u32 src_input_done_time3_l;        // R/w,0x968
         u32 src_input_done_time3_h;        // R/w,0x96c
         u32 src_calc_done_time3_l;         // R/w,0x970
         u32 src_calc_done_time3_h;         // R/w,0x974
};
